import { findCommandDefinitionByToken } from "./command-catalog";
...
export function parseCommandInput(rawInput: string, catalog: CommandCatalog): ParsedCommandInput {
  const raw = rawInput;
  ...
  if (trimmed.startsWith("/")) {
    ...
    const command = findCommandDefinitionByToken(catalog, name);
